...
import 'package:simplehive/widgets/toast.dart';

class AddAssociatePage extends StatefulWidget {
  AddAssociatePage({Key key}) : super(key: key);
...
class _AddAssociatePageState extends State<AddAssociatePage> {
  ...
  void _addAssociate(context) {
    ...
    Provider.of<AssociateData>(context, listen: false).addAssociate(Associate(
        name: name,
        age: age ?? 00,
        phone: phone ?? 0,
